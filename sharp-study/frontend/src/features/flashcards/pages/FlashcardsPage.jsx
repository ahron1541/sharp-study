...
export default function FlashcardsPage() {
  ...
  return (
    <>
      <main className="learning-content mx-auto w-full max-w-7xl px-4 py-4 sm:px-5 lg:px-6">
        ...
        <section className="flashcards-shell mt-3 rounded-[1.5rem] border border-[color:var(--color-border)] bg-[color:var(--color-surface)] p-3 shadow-[0_14px_44px_rgba(15,23,42,0.08)] sm:p-4">
          <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
            <div className="min-w-0">
              ...
              <h1 className="learning-title mt-1 truncate text-2xl font-black leading-tight text-[color:var(--color-text)] sm:text-3xl">{set.title}</h1>
              <p className="learning-copy-sm mt-1 text-[color:var(--color-text-muted)]">
        ...
        {orderedCards.length === 0 ? (
          <section className="mt-6 rounded-[2rem] border border-[color:var(--color-border)] bg-[color:var(--color-surface)] p-8 text-center">
            ...
            <p className="learning-copy mx-auto mt-3 max-w-md text-[color:var(--color-text-muted)]">
                ...
                >
                  ...
                  >
                    ...
                    <div className="flex flex-1 items-center justify-center px-2 py-6">
                      <p className="flashcard-study-copy max-w-4xl text-center font-bold text-[color:var(--color-text)]">
                        {currentCard.front}
                      </p>
                    </div>
                    ...
                    <AnimatePresence>
                      {hintVisible ? (
                        <MotionDiv
                          ...
                          exit={{ opacity: 0, y: 12 }}
                          className="learning-copy-sm mx-auto mb-3 max-w-lg rounded-[1rem] border border-[color:var(--color-border)] bg-[color:var(--color-surface)] p-3 text-[color:var(--color-text-muted)]"
                        >
      ...
      <div className="rounded-[2rem] border border-[color:var(--color-border)] bg-[color:var(--color-surface)] p-5 shadow-[0_20px_60px_rgba(15,23,42,0.1)] sm:p-6">
        <div className="flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
          <div className="min-w-0">
            ...
            <h2 className="learning-title mt-2 text-3xl font-black leading-tight text-[color:var(--color-text)]">Choose your flashcard challenge.</h2>
            <p className="learning-copy mt-3 max-w-3xl font-semibold text-[color:var(--color-text-muted)]">
        ...
        <div className="mt-6 grid gap-5 xl:grid-cols-[minmax(0,1fr)_minmax(16rem,22rem)]">
          ...
          <aside className="rounded-[1.5rem] border border-[color:var(--color-border)] bg-[color:var(--color-surface-2)] p-4">
            ...
            <p className="learning-copy mt-4 font-semibold text-[color:var(--color-text-muted)]">{selected.description}</p>
